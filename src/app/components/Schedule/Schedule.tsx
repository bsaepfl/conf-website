...
const stages: Stage[] = [
  ...
  
  {
    name: "Side Stage 2",
    events: [
      { time: "09:40", title: "nostr: bitcoin crypto (secp256k1) for social media: demos self-contained clients & a 'stories' format-spec", description: "" },
      ...
      { time: "10:35", title: "Julian Arcium: Privacy 2.0 with Arcium", description: "" },
