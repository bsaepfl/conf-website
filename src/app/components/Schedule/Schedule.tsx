  ...
  },
  {
    ...
    events: [
      ...
      { time: "17:10", title: "Nicolas Sierro: Self Sovereign Identity for Age assurance with ZK Proofs: from data privacy compliance to successful usage through suited business model", description: (
        <>
          - On-the-edge age estimation for data privacy compliance <br />
          - Self Sovereign Identity with credentials in wallet & Zero-Knowledge Proof <br />
          - Consumer usage success with no or minimal fees <br />
