...
const stages: Stage[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "16:05", title: "Leona: Stateless space", description: "Privacy has always been more expensive compared to products without privacy. Stateless architectures and client-side ZKPs have the potential to change this. In the near future, it will likely become possible to provide financial privacy affordably and at a global scale. I will talk about the rapid advancements in this field." },
      ...
      { time: "17:00", title: "Piotr Mikołajczyk: Boulevard of broken proofs", description: " Zero-knowledge circuits require precision, where even the smallest oversight can introduce serious vulnerabilities. This talk explores subtle but high-impact issues discovered during audits and reviews—illustrating how minor inconsistencies in constraints or missing checks can lead to unexpected and dangerous behavior." },
  ...
  
  {
    name: "Side Stage 2",
    events: [
      { time: "09:40", title: "Bastiaan Quast: nostr: bitcoin crypto (secp256k1) for social media: demos self-contained clients & a 'stories' format-spec", description: "Nostr is social media protocol based on the same cryptography as Bitcoin (secp256k1), it has millions of users. I would like to demo self-contained HTML clients (avoid app stores) and a specification for a stories format (like instagram), w. demo app" },
      ...
      { time: "10:35", title: "Julian Arcium: Privacy 2.0 with Arcium", description: "Arcium introduced a new paradigm of trustless and efficient privacy – Privacy 2.0 – encrypted computing for any application" },
      ...
      { time: "14:40", title: "Sisyfos: Starknet Ecosystem" },
      { time: "15:00", title: "Damian Straszak: Privacy vs Bad Actors", description: "Improving users' privacy is one of the most important goals of research and development in blockchain technologies. The recent rapid progress in zero-knowledge research made it possible to build practical systems where users can deposit public tokens and later withdraw them with the link between these two events being cryptographically nullified. Such systems, while bringing privacy to public, transparent blockchains, sadly, have also gained attention of bad actors, with the most familiar example being hackers, laundering stolen funds via the Tornado Cash protocol on Ethereum. In this talk, I would like to dive deep into this problem and discuss possible solutions -- designs of private systems that are still permissionless, yet attempt to disincentivize bad actors from using them." },
