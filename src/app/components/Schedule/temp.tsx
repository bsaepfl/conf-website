...
const stages: Stage[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "14:05", title: "Christian Knabenhans: Making lattice-based PETs easy to use", description: "Cryptographic primitives built from  assumptions are versatile and powerful building blocks for privacy-preserving applications. However, lattice-based cryptography (in particular zero-knowledge proofs) are scarcely implemented, in part because of the complexity of reasoning about and parametrizing them. In this talk, I introduce lattirust, a comprehensive and high-assurance lattice cryptography library, written in Rust, which adresses these challenges. " },
  ...
  },
  {
    ...
    events: [
      ...
      { time: "17:10", title: "Nicolas Sierro: Self Sovereign Identity for Age assurance with ZK Proofs: from data privacy compliance to successful usage through suited business model", description: "- On-the-edge age estimation for data privacy compliance" },
    ],
  },
];
