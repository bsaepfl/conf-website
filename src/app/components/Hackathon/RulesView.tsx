      ...
      <div className="w-full max-w-[1100px] flex flex-col py-20 px-4 sm:px-10 gap-8 text-sm sm:text-base ">
        ...
        <div className="w-full flex items-center justify-center lg:justify-start">
          <a
            ...
            target="_blank"
            download
            className="w-fit gap-3 uppercase rounded-md bg-dark-100 hover:bg-white border border-dark-900 text-white font-medium hover:text-dark-100 hover:border-dark-100 duration-100 px-10 py-2"
          >
            Download
          </a>
        </div>
