    ...
    <div className="relative min-h-[75vh] w-full flex flex-col items-center justify-center bg-base-200">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-4">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-black">Privacy x Verifiability</h1>
          <h1 className="text-4xl font-bold text-black">Conference</h1>

          <p className="text-xl  mt-4 text-black">Join us for a deep dive into the latest in blockchain privacy and verifiability.</p>
        </div>
